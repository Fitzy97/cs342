...
public class BreakfastActivity extends MainActivity implements ASyncInterface {
    ...
    public void processFinish(ArrayList<String> output) {
        breakfastText.setText(output.get(0));
        breakfastText2.setText(output.get(1));
    }

    private class DisplayBreakfast extends AsyncTask<URL, Integer, ArrayList<String>> {

        public ASyncInterface delegate = null;

        public ArrayList<String> doInBackground(URL... urls) {
            return parseForBreakfast(urls[0].toString());
        }
